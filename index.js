...
// it is able to access because nested functions allow you to access the variable in the parent.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(zooAnimals){
    const totPop = zooAnimals.reduce((a,b) => a + b.population,0)
    return totPop;
  }
...
const cuboid = new CuboidMaker(cube);
